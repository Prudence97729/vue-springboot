...
console.log('当前 token:', tokenStore.token)  // 检查 token 是否存在

const uploadSuccess = (res) => {
  console.log('上传响应:', res)
  if (res.code === 200) {  // 修改为与后端一致的成功状态码
  ...
  <el-card class="page-container">
    ...
    <el-form inline>
      ...
      <el-form-item label="发布状态：">
        <el-select placeholder="请选择" style="width: 240px" v-model="state">
